...
---
$\require{mhchem} \ce{}$The plots on the right show the distribution of results for four experiments. Each plot shows the frequency of a particular outcome on the *y*-axis as a function of possible outcomes on the *x*-axis. These experiments are:
...
Each of these distributions has a different shape and structure, and, therefore, a different mathematical form. Before continuing, take a moment to make note of the similarities and differences in the pattern of the data in these data sets and in the way these data sets are presented.
